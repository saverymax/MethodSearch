...
"""
"Quick" script to take all sections from full_texts, clean the dates, sort them by date, and insert the newest n docs of each label in test db
"""
#psql
...
print(merged_df['date'].tail())

db.test_new_v2.remove({})
db.test_new_v2.insert_many(mongo_entry)
