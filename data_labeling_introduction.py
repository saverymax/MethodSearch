            ...
            for i in sec:
                ...
                if i.text != None:
                    ...
                    if text in self.label_constants:
                        ...
                        #print(i.getparent().getparent()) # nice way to get grandparent
                        #print("Found", i.text)
                        return {'title': i.text}
...
if __name__ == '__main__':
    ...
    label_string = 'introduction'

    label_list = introduction_constants.introduction_label
    #print(label_list)
        ...
        for doc in document_generator:
            try:
                ...
                if 'title' in label_name_dict:
                    ...
                    # mongo way
                    labeler.add_element_mongo(label_string, xml_string, journal, doc, date, location)
    ...
    print("introduction {0}!, no introduction {1}".format(total_label, total_no_label))
