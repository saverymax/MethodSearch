...
class data_labeler():
    ...
    def __init__(self, directory, methods):
        ...
        self.method_constants = [method.lower() for method in methods]
        #self.documents =[]
    ...
    def mongo_connection(self):
        ...
        self.documents = self.db['texts_v2'] # creates new collection if not there
        ...
        try:
            ...
            for i in sec:
                if i.text != None:
                    ...
                    if text in self.method_constants:
                        if '&' in i.text:
...
if __name__ == '__main__':
    ...
    label_list = label_lists['methods']
        ...
        for doc in document_generator:
            try:
                ...
                if 'title' in label_name_dict:
                    ...
                    # the mongo way
                    labeler.add_element_mongo('method', xml_string, journal, doc, date, location)
    ...
    print("methods {0}!, no methods {1}".format(total_label, total_no_label))
